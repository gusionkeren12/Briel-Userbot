...
async def _(ping):
    ...
    start = datetime.now()
    Ayiin = await edit_or_reply(ping, "**☠︎**")
    await Ayiin.edit("**☠︎☠︎**")
    await Ayiin.edit("**☠︎☠︎☠︎**")
    await Ayiin.edit("**☠︎☠︎☠︎☠︎**")
    await Ayiin.edit("**☠︎☠︎☠︎☠︎☠︎**")
    end = datetime.now()
    ...
    await Ayiin.edit(
        ...
        f"☠︎ **𝙿𝙸𝙽𝙶𝙴𝚁 :** `%sms`\n"
        f"☠︎ **𝚄𝙿𝚃𝙸𝙼𝙴 :** `{uptime}` \n"
        f"☠︎ **𝙾𝚆𝙽𝙴𝚁 :** [{user.first_name}](tg://user?id={user.id})" % (duration)
    )
